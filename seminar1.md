...
Для перемещения между коммитами(сохранениями) используется команда *git checkout commit_number*

Команда *git checkout name_branch* используется для перехода между ветками